              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                      ...
                      child: SGTouchable(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius:
                                BorderRadius.circular(Responsive.r(20)),
                            border: Border.all(
                    ...
                    Padding(
                      padding:
                          Responsive.symmetric(vertical: 20, horizontal: 40),
                      child: Row(
                        children: List.generate(
                            ...
                            (index) => Expanded(
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color:
                                          AppTheme.text1.withValues(alpha: 0.7),
                    ...
                    Padding(
                      ...
                      child: SGTouchable(
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            borderRadius:
                                BorderRadius.circular(Responsive.r(18)),
                            child: Stack(
                              children: [
                    ...
                    Padding(
                      padding:
                          Responsive.symmetric(horizontal: 20, vertical: 10),
                      child: SGTouchable(
                        onTap: _startPvp,
                        child: Container(
                          width: double.infinity,
                    ...
                    SizedBox(
                        height: Responsive.h(120)), // Bottom padding for navbar
                  ],
                ),
              ),
            ),
